    ...
    setText () {
        ...
        while (1) {
            ...
            if (text[i + 1] == "#") {
                ...
                if (en == "nbsp") text = text.substr(0, i) + "\xA0" + text.substr(j + 1);
                // 解决 &nbsp; 失效
        ...
        if (!cfg.ignoreTags[node.name]) {
            ...
            if (!close) this.remove(node);
                ...
                var parent = this.parent(),
                    attrs = node.attrs;
                if (parent && attrs.src)
                    if (parent.name == "video" || parent.name == "audio") parent.attrs.source.push(attrs.src);
                    else {
                        var i,
                            media = attrs.media;
                        if (
    ...
    matchAttr (node) {
        ...
        if (node.name == "img" || node.name == "picture") {
            ...
            if (check("width")) {
                ...
                if (parseInt(styleObj.width) > screenWidth) styleObj.height = "auto";
